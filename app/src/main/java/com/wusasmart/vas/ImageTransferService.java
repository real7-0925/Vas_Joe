...
public class ImageTransferService extends Service {
    ...
    //added
    //4/7要用
    public static final UUID SENSOR_INFO_CHAR_UUID = UUID.fromString("6e400005-b5a3-f393-e0a9-e50e24dcca3e");
    //之後備用
    public static final UUID WUSA_COMMAND_CHAR_UUID = UUID.fromString("6e400006-b5a3-f393-e0a9-e50e24dcca3e");
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        //************************************************//
        //add filter here to get charateristic from uuid when CharacteristicChange
        //broadcastUpdate put charateristic to intent.put extra file
        //*************************************************//
        @Override
    ...
    public class LocalBinder extends Binder {
        com.wusasmart.vas.ImageTransferService getService() {
            return com.wusasmart.vas.ImageTransferService.this;
        }
    }
    ...
    //*********************************************//
    //use this command to pass data back to device
    //BluetoothGattCharacteristic   RxService.getCharacteristic(RX_Char_UUID)
    //command in enum =0,1,2,3,4 ....   []data  passed data
    //*********************************************//
